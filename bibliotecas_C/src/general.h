...
/***
 * \fn int grl_Count_Letters(char*)
 * \brief  Cuenta la catidad de caracteres de la cadena
 *
 * \param Cadena a la que se le van a contar los caracteres
 * \return Retorna - 1 en caso de error, o el numero de caracteres de la cadena
 */
int grl_Count_Letters(char*);
